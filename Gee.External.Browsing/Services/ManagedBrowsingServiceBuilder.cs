...
namespace Gee.External.Browsing.Services {
    ...
    public sealed class ManagedBrowsingServiceBuilder : BaseBrowsingServiceBuilder<ManagedBrowsingServiceBuilder> {
        ...
        ///     This managed service builder.
        /// </returns>
        public ManagedBrowsingServiceBuilder RestrictUpdatesTo(ThreatListName threatListName) {
        ...
        /// </exception>
        public ManagedBrowsingServiceBuilder RestrictUpdatesTo(ThreatListName threatListName, Func<ThreatListUpdateConstraintsBuilder, ThreatListUpdateConstraints> updateConstraintsAction) {
            Guard.ThrowIf(nameof(updateConstraintsAction), updateConstraintsAction).Null();
        ...
        /// </param>
        /// <param name="updateConstraints">
        ///     The <see cref="ThreatListUpdateConstraints" /> to apply when the <see cref="ThreatListName" /> identified
        ...
        /// </exception>
        public ManagedBrowsingServiceBuilder RestrictUpdatesTo(ThreatListName threatListName, ThreatListUpdateConstraints updateConstraints) {
            Guard.ThrowIf(nameof(updateConstraints), updateConstraints).Null();
